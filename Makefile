...
CP_AV=cp -av
CURL_DL=curl -LJ
KMD_UNIX_URL=https://github.com/Meshbits/komodo/releases/download/research_release1/komodo-linux_23Sept2020.zip -o komodo_linux.zip
KMD_OSX_URL=https://github.com/Meshbits/komodo/releases/download/research_release1/komodo-macos_23Sept2020.zip -o komodo_macos.zip
